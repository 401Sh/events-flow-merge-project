...
export class ParticipantsController {
  ...
  async getLeaderUserEventsHistory(
    ...
    return await this.participantsService.getUserEventHistory(userId, isCompleted);
  }
  ...
  async subscribeEvent(
    ...
    return await this.participantsService.subscribeToEvent(userId, eventId);
  }
  ...
  async unsubscribeToEvent(
    ...
    await this.participantsService.unsubscribeToEvent(userId, eventId);
  }
}